...
if st.session_state.page == 'accueil':
    ...
    st.markdown(f"<p style='text-align: center; font-size: 18px; color: #aaaaaa;'>Plongez dans l'histoire. Retrouvez plus de <b>4000</b> matchs mythiques documentés et détaillés.</p>", unsafe_allow_html=True)
    st.write("")
